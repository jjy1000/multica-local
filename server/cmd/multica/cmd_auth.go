...
// in server/internal/middleware/auth.go. The mcn_ Cloud Fleet prefix was
// removed with the cloud-billing/cloud-runtime stack in the localized
// build; only mul_ (local Personal Access Tokens) remains.
