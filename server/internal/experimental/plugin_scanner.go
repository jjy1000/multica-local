...
//
// Converts user_plugin DB rows into Flag structs that the Registry
// merges alongside the built-in Catalog. User plugin flag keys always
// carry the "user_" prefix to avoid collisions with built-in flags.
