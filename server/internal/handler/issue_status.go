...
func (h *Handler) CreateIssueStatus(w http.ResponseWriter, r *http.Request) {
	...
	// Rollout gate (see featureflag.CustomIssueStatuses). Creating the first
	...
	if !featureflag.CustomIssueStatusesEnabled(r.Context(), h.FeatureFlags) {
	...
	// createIssueStatusEntry. (MUL-6749)
