...
func (h *Handler) GetConfig(w http.ResponseWriter, r *http.Request) {
	...
	// CdnSigned was a CloudFront-cookie signing flag driven by h.CFSigner.
	// The CDN-signing stack was removed with cloud-billing/cloud-runtime
	// in the localized build, so this is always false. The field is kept
	// for back-compat with existing /api/config consumers that branch on
	// it; treat it as a no-op signal.
	config.CdnSigned = false
