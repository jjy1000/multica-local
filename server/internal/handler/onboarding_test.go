...
// ---------------------------------------------------------------------------
// 0.3.66 (M3 PR1): the BootstrapOnboarding* handlers and their tests
// were removed. onboarding_shim.go (613 lines, 5 helper funcs) +
// TestBootstrapOnboarding* (5 tests, 464 lines) deleted. router.go
// dropped the two POST routes. JoinCloudWaitlist tests above remain;
// that handler is a separate PR (M3 PR2) because the web landing
// page still calls it.
// ---------------------------------------------------------------------------
