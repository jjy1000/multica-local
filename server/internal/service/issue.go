...
type IssueCreateParams struct {
	...
	Stage pgtype.Int4
	// LabSource associates the issue with an experimental lab (e.g.
	// "claude_science_lab", "mythos_swarm"). NULL = not lab-associated.
	LabSource pgtype.Text
	// LabMode (0.3.31) — mythos_swarm dual-mode. "sole" or "enhancer".
	// NULL means no mode set (treated as sole by the renderer).
	LabMode pgtype.Text
}
