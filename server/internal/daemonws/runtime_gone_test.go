...
// Ported from upstream 731af7ccd (MUL-7002 half 1): the runtime-gone push
// shares the wire frame with heartbeat acks but MUST NOT pollute the wakeup
// delivery/publish metrics — every test below pins that separation.
