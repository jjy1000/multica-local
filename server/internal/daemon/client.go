...
func (c *Client) CompleteTask(ctx context.Context, taskID, output, branchName, sessionID, workDir string) error {
	return c.completeTaskWithRetrySchedule(ctx, taskID, output, branchName, sessionID, workDir, defaultTerminalRetrySchedule)
}

func (c *Client) completeTaskWithRetrySchedule(ctx context.Context, taskID, output, branchName, sessionID, workDir string, schedule []time.Duration) error {
...
func (c *Client) FailTask(ctx context.Context, taskID, errMsg, sessionID, workDir, failureReason string) error {
	return c.failTaskWithRetrySchedule(ctx, taskID, errMsg, sessionID, workDir, failureReason, defaultTerminalRetrySchedule)
}

func (c *Client) failTaskWithRetrySchedule(ctx context.Context, taskID, errMsg, sessionID, workDir, failureReason string, schedule []time.Duration) error {
