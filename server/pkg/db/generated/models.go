...
type ExperimentalClaudeRuntimeSession struct {
	ID          pgtype.UUID        `json:"id"`
	WorkspaceID pgtype.UUID        `json:"workspace_id"`
	AgentID     pgtype.UUID        `json:"agent_id"`
	IssueID     pgtype.UUID        `json:"issue_id"`
	...
	FinishedAt  pgtype.Timestamptz `json:"finished_at"`
	ExpiresAt   pgtype.Timestamptz `json:"expires_at"`
	LabID       pgtype.UUID        `json:"lab_id"`
	LabSource   pgtype.Text        `json:"lab_source"`
}

type ExperimentalPref struct {
	ID        pgtype.UUID        `json:"id"`
	UserID    pgtype.UUID        `json:"user_id"`
...
type ExperimentalResourceLock struct {
	ID                 pgtype.UUID        `json:"id"`
...
type ExperimentalResourceVisibility struct {
	ID           pgtype.UUID        `json:"id"`
	FlagKey      string             `json:"flag_key"`
	ResourceType string             `json:"resource_type"`
	ResourceID   pgtype.UUID        `json:"resource_id"`
...
type ExperimentalRuntimeArtifact struct {
	ID          pgtype.UUID        `json:"id"`
