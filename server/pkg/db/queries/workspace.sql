...
-- service. Returns just the workspace IDs so the caller can iterate
-- without loading the full workspace row. Distinct is implicit
-- (workspace.id is the primary key).
