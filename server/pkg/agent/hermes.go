...
type hermesClient struct {
	...
	// scopes it to Config.BuiltinRuntime: a custom runtime profile declaring
	// `protocol_family: hermes` (jcode is the documented example) reaches this
	// backend as "hermes" while being an unrelated implementation, and only the
	// real Hermes Agent binary is known to behave this way —
	// acp_adapter/tools.py's build_tool_call passes
