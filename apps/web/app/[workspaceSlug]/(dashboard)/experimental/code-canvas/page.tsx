...
// 0.5.17 (B2c): web stub for the Code Canvas desktop surface.
// The full view drives an interactive Monaco canvas + per-workspace
// subprocess — desktop-only.
export default function CodeCanvasStubPage() {
    ...
    <div className="mx-auto w-full max-w-3xl px-8 py-10">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">
          {tLayout(($) => $.sidebar.experimental_code_canvas)}
        </h1>
      </div>
      <p className="mb-6 text-sm text-muted-foreground">
        {tExp(($) => $.web_stubs.desc_code_canvas)}
      </p>
      <Card>
        <CardHeader>
