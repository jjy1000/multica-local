-- Renumbered from upstream 350_agent_task_queue_chat_retired_session_index.up.sql → fork 260.
...
-- folding this into migration 259's terminal predicate could resurrect a
