  ...
  return (
    <div>
      ...
      <div className="mt-6 divide-y">
        ...
        {/* PR 3 attribution: Multica bundles PostgreSQL via Postgres.app.
            Both are BSD-licensed; we surface the upstream credit in the
            Settings → Updates panel since it's the closest thing to an
            "About" surface in the desktop UI. */}
        <div className="flex items-start justify-between gap-6 py-4">
          <div className="min-w-0">
            <p className="text-sm font-medium">Open-source attribution</p>
            <p className="text-sm text-muted-foreground mt-0.5 leading-relaxed">
              Multica bundles PostgreSQL via{" "}
              <a
              ...
              (PostgreSQL License / BSD). Source:{" "}
              <a
                href="https://github.com/PostgresApp/PostgresApp"
                target="_blank"
                rel="noreferrer"
                className="underline hover:text-foreground"
              >
