...
// Inline media resolves to blob: URLs, so URL.createObjectURL/revokeObjectURL
// are load-bearing in the byte fallback paths. Stub them per-test so the
// created/revoked calls are assertable, and restore afterwards.
