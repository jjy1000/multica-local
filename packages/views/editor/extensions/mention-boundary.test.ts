...
//
// Fork note: upstream's MUL-5429 typed-`@` provenance check
// (`SuggestionTriggerArmingExtension` / `isTriggerArmedAt`) is not ported here,
// so this file pins the boundary half only.
