...
> = {
  // -- Anthropic: current generation. Fable 5 and 5.1 are Mythos-class SKUs
  //    at 10/50 (5.1 prices cache reads at 0.025x input, a quarter of the
  //    usual 0.1x); Opus 4.5+ stays on the lower 5/25 Opus tier. --
