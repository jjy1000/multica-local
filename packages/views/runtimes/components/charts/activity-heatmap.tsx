...
export function ActivityHeatmap({
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- pricings is the user override store snapshot; aggregateByWeek reads it via the custom-pricing store, not as a function arg. Without listing it the memo would cache pre-override totals whenever only the override store changes.
  }, [usage, pricings, tz]);
