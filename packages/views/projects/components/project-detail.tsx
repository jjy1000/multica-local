...
export function ProjectDetail({ projectId }: { projectId: string }) {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- project is destructured field-by-field into the dep array above; listing the full object would re-fire whenever any unrelated field mutates.
  ...
  const filteredAgents = agents.filter((a) => !a.archived_at && !a.lab_managed && (a.name.toLowerCase().includes(leadQuery) || matchesPinyin(a.name, leadQuery)));
