...
> **Current release: 0.5.26 (committed 2026-08-17, shipped + installed at /Applications/Multica.app).**
...
> Next: audit other dormant retention ladders (other `expires_at` columns with no working GC) or new MUL fix batch. Deferred: MUL-6053/6102 (Hermes — fork never touches HERMES_HOME), MUL-5991 (user skip, no jcode), 0c69f1f95 (user defer, symptom not observed).
>
