...
> - **0.5.40 MUL-6330 exact-prefix ranking** (`e42b2883e`): slash-command suggestion ranks matches as exact name > name prefix > name substring > description. 5 new tests pin tier ordering + 20-item cap interaction.
> - **0.5.40 CVE-2026-9277 dep bump** (`19115a4b6`): `shell-quote` 1.8.3 → 1.9.0, transitive via `react-devtools-core@6.1.5` (dev-only). Forced via `pnpm.overrides`.
